...
# Growth by County {.tabset .tabset.fade .tabset-pills}
...
```{r county-area-map-setup, include=FALSE}
area_directory <- 'c:/coding/vision-output/inputs/shapefiles/areas'
areas_to_map <- list(list("#F05A28",'county_id_king',"King"),list("#8CC63E",'county_id_kitsap',"Kitsap"),list("#00A7A0",'county_id_pierce',"Pierce"),list("#91268F",'county_id_snohomish',"Snohomish"))
...
# Capacity by County {.tabset .tabset.fade .tabset-pills}
...
# Growth by Large Area {.tabset .tabset.fade .tabset-pills}
By `r toString(analysis_years[[2]])`, xxx.
...
```{r la-area-map-setup, include=FALSE}
area_directory <- 'c:/coding/vision-output/inputs/shapefiles/areas'
areas_to_map <- list(list("#F05A28",'large_area_id_nw_snohomish',"NW Snohomish"),list("#8CC63E",'large_area_id_everett',"Everett"),list("#00A7A0",'large_area_id_sw_snohomish',"SW Snohomish"),list("#91268F",'large_area_id_snohomish_other',"Snohomish Other"), list("#76787A",'large_area_id_shoreline',"Shoreline"),list("#F05A28",'large_area_id_seattle',"Seattle"),list("#8CC63E",'large_area_id_eastside_king',"Eastside King"),list("#00A7A0",'large_area_id_sw_king',"SW King"),list("#91268F",'large_area_id_green_river',"Green River"), list("#76787A",'large_area_id_se_king',"SE King"),list("#F05A28",'large_area_id_king_other',"King Other"),list("#8CC63E",'large_area_id_tacoma',"Tacoma"),list("#00A7A0",'large_area_id_sw_pierce',"SW Pierce"),list("#91268F",'large_area_id_pierce_other',"Pierce Other"), list("#76787A",'large_area_id_peninsula',"Peninsula"),list("#F05A28",'large_area_id_south_kitsap',"South Kitsap"),list("#8CC63E",'large_area_id_central_kitsap',"Central Kitsap"),list("#00A7A0",'large_area_id_north_kitsap',"North Kitsap"))
working_map <- create_area_map(areas_to_map,area_directory)
```
...
# Capacity by Large Area {.tabset .tabset.fade .tabset-pills}
...
```{r ta-map-setup, include=FALSE}
area_directory <- 'c:/coding/vision-output/inputs/shapefiles/areas'
areas_to_map <- list(list("#F05A28",'tod_id_lrt',"Light Rail"),list("#8CC63E",'tod_id_crt',"Commuter Rail"),list("#00A7A0",'tod_id_pof',"Passenger Only Ferry"),list("#91268F",'tod_id_brt',"Bus Rapid Transit"), list("#76787A",'tod_id_rgc',"Regional Growth Centers"))
working_map <- create_area_map(areas_to_map,area_directory)
```
...
area_directory <- 'c:/coding/vision-output/inputs/shapefiles/areas'
areas_to_map <- list(list("#F05A28",'hct_id_hct',"High Capacity Transit"))
working_map <- create_area_map(areas_to_map,area_directory)
```
...
area_directory <- 'c:/coding/vision-output/inputs/shapefiles/areas'
areas_to_map <- list(list("#F05A28",'rgeo_id_metro',"Metro Cities"),list("#8CC63E",'rgeo_id_core',"Core Cities"),list("#00A7A0",'rgeo_id_hct',"High Capacity Transit Cities"),list("#91268F",'rgeo_id_cities',"Cities & Towns"), list("#76787A",'rgeo_id_uu',"Urban Unicorporated"))
working_map <- create_area_map(areas_to_map,area_directory)
```
