...
```{r create_lookup_shapefiles, include = FALSE}
library(reticulate)
...
```{r rgc-ta-map-setup, include=FALSE}
area_directory <- 'c:/coding/vision-output/inputs/shapefiles/areas'
...
## VMT {.tabset .tabset.fade .tabset-pills}
xxx
```{r vmt, include=FALSE}
out <- NULL
...
for (measures in travel_measures) {
  summary_attributes <- c('Daily Vehicle Miles Traveled')
  summary_columns <- c("Today","2050","Delta","% Change")
  w_att <- 'Daily VMT'
  w_geo <- measures[[2]]
  w_grp <- "Total"
...
## VHT {.tabset .tabset.fade .tabset-pills}
xxx
```{r vht, include=FALSE}
out <- NULL
...
for (measures in travel_measures) {
  summary_attributes <- c('Daily Vehicle Hours Traveled')
  summary_columns <- c("Today","2050","Delta","% Change")
  w_att <- 'Daily VHT'
  w_geo <- measures[[2]]
  w_grp <- "Total"
...
## Vehicle Delay {.tabset .tabset.fade .tabset-pills}
xxx
```{r vhd, include=FALSE}
out <- NULL
...
for (measures in travel_measures) {
  summary_attributes <- c('Daily Vehicle Hours of Delay')
  summary_columns <- c("Today","2050","Delta","% Change")
  w_att <- 'Daily Delay'
  w_geo <- measures[[2]]
  w_grp <- "Total"
...
## Medium Truck Delay {.tabset .tabset.fade .tabset-pills}
xxx
```{r mt_delay, include=FALSE}
out <- NULL
...
for (measures in travel_measures) {
  summary_attributes <- c('Daily Medium Truck Hours of Delay')
  summary_columns <- c("Today","2050","Delta","% Change")
  w_att <- 'Daily Medium Truck Delay'
  w_geo <- measures[[2]]
  w_grp <- "Total"
  output_type <- "integer"
  out <- c(out, knitr::knit_child("transportation-metrics-child.Rmd"))
...
## Heavy Truck Delay {.tabset .tabset.fade .tabset-pills}
xxx
```{r ht_delay, include=FALSE}
out <- NULL

travel_measures <- list(list("King","King County"),list("Kitsap","Kitsap County"), list("Pierce","Pierce County"), list("Snohomish","Snohomish County"))

for (measures in travel_measures) {
  summary_attributes <- c('Daily Heavy Truck Hours of Delay')
  summary_columns <- c("Today","2050","Delta","% Change")
  w_att <- 'Daily Heavy Truck Delay'
  w_geo <- measures[[2]]
  w_grp <- "Total"
  output_type <- "integer"
  out <- c(out, knitr::knit_child("transportation-metrics-child.Rmd"))
...
travel_measures <- list(list("CT","Community Transit"),list("ET","Everett Transit"), list("KCM","King County Metro"), list("KT","Kitsap Transit"), list("PT","Pierce Transit"),list("ST","Sound Transit"),list("WSF","Washington Ferries"),list("Region","Regional"))


for (measures in travel_measures) {
  summary_attributes <- c(measures[[2]])
  summary_columns <- c("Today","2050","Delta","% Change")
  w_att <- "Daily Transit Boardings"
  w_geo <- measures[[2]]
  w_grp <- "Total"
  output_type <- "integer"
  out <- c(out, knitr::knit_child("transportation-metrics-child.Rmd"))
...
## Commute Mode Share for Transit {.tabset .tabset.fade .tabset-pills}
xxx
...
## Non-Commute Mode Share for Transit {.tabset .tabset.fade .tabset-pills}
xxx
```{r non-comm-trn, include=FALSE}
out <- NULL
...
for (measures in travel_measures) {
  summary_attributes <- c(measures[[2]])
  summary_columns <- c("Today","2050","Delta","% Change")
  w_att <- "Non-Commute Trip Mode Share"
  w_geo <- measures[[2]]
  w_grp <- "Transit"
  output_type <- "percentage"
  out <- c(out, knitr::knit_child("transportation-metrics-child.Rmd"))
