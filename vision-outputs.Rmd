...
working_table <- clean_summary_datatable(working_dt,"Region",working_names,working_names,working_order)
working_table <- working_table[type %in% "population"]
final_table <- dcast(working_table, index ~ scenario, value.var = values_to_cast)
final_table$index <- factor(final_table$index, levels = final_row_order)
...
working_table <- clean_summary_datatable(working_dt,"Region",working_names,working_names,working_order)
working_table <- working_table[type %in% "households"]
final_table <- dcast(working_table, index ~ scenario, value.var = values_to_cast)
final_table$index <- factor(final_table$index, levels = final_row_order)
final_table <- final_table[order(index),]
...
working_table <- clean_summary_datatable(working_dt,"Region",working_names,working_names,working_order)
working_table <- working_table[type %in% "employment"]
final_table <- dcast(working_table, index ~ scenario, value.var = values_to_cast)
final_table$index <- factor(final_table$index, levels = final_row_order)
final_table <- final_table[order(index),]
...
working_table <- clean_summary_datatable(working_dt,"King",working_names,working_names,working_order)
working_table <- working_table[type %in% "population"]
final_table <- dcast(working_table, index ~ scenario, value.var = values_to_cast)
final_table$index <- factor(final_table$index, levels = final_row_order)
final_table <- final_table[order(index),]
...
working_table <- clean_summary_datatable(working_dt,"Kitsap",working_names,working_names,working_order)
working_table <- working_table[type %in% "population"]
final_table <- dcast(working_table, index ~ scenario, value.var = values_to_cast)
final_table$index <- factor(final_table$index, levels = final_row_order)
final_table <- final_table[order(index),]
...
working_table <- clean_summary_datatable(working_dt,"Pierce",working_names,working_names,working_order)
working_table <- working_table[type %in% "population"]
final_table <- dcast(working_table, index ~ scenario, value.var = values_to_cast)
final_table$index <- factor(final_table$index, levels = final_row_order)
final_table <- final_table[order(index),]
...
working_table <- clean_summary_datatable(working_dt,"Snohomish",working_names,working_names,working_order)
working_table <- working_table[type %in% "population"]
final_table <- dcast(working_table, index ~ scenario, value.var = values_to_cast)
final_table$index <- factor(final_table$index, levels = final_row_order)
final_table <- final_table[order(index),]
...
working_table <- clean_summary_datatable(working_dt,"minority",working_names,working_names,working_order)
working_table <- working_table[type %in% "population"]
final_table <- dcast(working_table, index ~ scenario, value.var = values_to_cast)
final_table$index <- factor(final_table$index, levels = final_row_order)
final_table <- final_table[order(index),]
