...
create_opportunity_table <- function(tbl, vars, to_cast, final_order) {
...
opp <- partial(create_opportunity_table, vars = wrk_vars, to_cast = values_to_cast, final_order=final_row_order)
...
fmt <- partial(create_clean_table,cols=final_columns,shr_cols=percent_columns,num_cols=numeric_columns,tbl_container=ht_table_container)
