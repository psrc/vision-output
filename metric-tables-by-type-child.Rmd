...
for (files in alternatives) {
  ...
  if (header_names[[wrk_num]][[1]] == "Total") {
    wrk_tbl <- data.table(TOD=tod_names, People=unlist(results_by_type[[paste0(files[[2]],"_",analysis_years[[2]],"_",header_names[[wrk_num]][[2]])]]),Jobs=unlist(results_by_type[[paste0(files[[2]],"_",analysis_years[[2]],"_",header_names[[wrk_num]][[3]])]]))
